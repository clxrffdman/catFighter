class PlayFour extends Phaser.Scene {
    hunger = 0;
    constructor() {
        super("play4Scene");
    }
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("platform_map4", "./assets/testLevel4.json");    // Tiled JSON file
    ...
    create() {
        ...
        // add a tilemap
        this.map = this.add.tilemap("platform_map4");
